 ...
 */
  ...
  async receivePack(req, commands, objects) {
    ...
    if (this.headref) {
      ...
      await this.collection.updateOne({ repo: this.repoName, ref: "HEAD" }, { $set: { repo: this.repoName, name: "HEAD " + this.headref, ref: "HEAD", sha: headsha, _type: "hash", _acl, _created, _modified } }, { upsert: true })
    }
  }
  /**
